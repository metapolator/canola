...
@dictionary {
    center {
        nailtotrb: S"master#blackwide glyph#C penstroke#bow point:i(0) right":on;
...
@dictionary {
    center {
        nailtotrb: S"master#blackwide glyph#E penstroke#armt point:i(1) center":on;
        nailtobrt: S"master#blackwide glyph#E penstroke#armb point:i(1) center":on;
        nailtocrt: S"master#blackwide glyph#E penstroke#armc point:i(1) center":on;
        nailtocrb: S"master#blackwide glyph#E penstroke#armc point:i(1) center":on;
...
@dictionary {
    center {
        nailtotrb: S"master#blackwide glyph#F penstroke#armt point:i(1) center":on;
        nailtocrt: S"master#blackwide glyph#F penstroke#armc point:i(1) center":on;
        nailtocrb: S"master#blackwide glyph#F penstroke#armc point:i(1) center":on;        
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtotrb: S"master#blackwide glyph#G penstroke#bow point:i(0) right":on;
        nailtobow: S"master#blackwide glyph#G penstroke#bow point:i(4) right":on;
        nailtobary: S"master#blackwide glyph#G penstroke#bar point:i(0) right":on:y;
        nailtobarx: S"master#blackwide glyph#G penstroke#stem point:i(0) center":on:x;
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtobrt: S"master#blackwide glyph#L penstroke#arm point:i(1) center":on;   
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtoblt: S"master#blackwide glyph#S penstroke#bow point:i(0) right":on;   
        nailtotrb: S"master#blackwide glyph#S penstroke#bow point:i(6) left":on;   
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtoblt: S"master#blackwide glyph#dollar penstroke#bow point:i(0) right":on;   
        nailtotrb: S"master#blackwide glyph#dollar penstroke#bow point:i(6) left":on;   
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtotrb: S"master#blackwide glyph#T penstroke#arm point:i(1) center":on;
        nailtotlb: S"master#blackwide glyph#T penstroke#arm point:i(0) center":on;
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtobrt: S"master#blackwide glyph#Z penstroke#stem point:i(-1) center":on;
        nailtotlb: S"master#blackwide glyph#Z penstroke#stem point:i(0) center":on;
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    left {
        A: pointBefore:on:y;
        B: pointAfter:on:x;
        C: S"master#blackwide glyph#Z penstroke#stem point:i(1) right":on:y;
        D: pointBefore:on:x;
    }
    right {
        A: pointAfter:on:y;
        B: pointBefore:on:x;
        C: S"master#blackwide glyph#Z penstroke#stem point:i(-1) left":on:y;
        D: pointAfter:on:x;
    }
...
@dictionary {
    center {
        nailtotlb: S"master#blackwide glyph#a penstroke#bow point:i(3) right":on;
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtotrb: S"master#blackwide glyph#f penstroke#bow point:i(3) left":on;
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtotrb: S"master#blackwide glyph#r penstroke#bow point:i(1) center":on;
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtoblt: S"master#blackwide glyph#uni0904 penstroke#bow point:i(0) right":on;   
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtoblt: S"master#blackwide glyph#aadeva penstroke#bow point:i(0) right":on;   
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtoblt: S"master#blackwide glyph#adeva penstroke#bow point:i(0) right":on;   
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
penstroke#bow3 point:i(2) > right{
    inTension: 0.95 * extraTension * base:inTension;
    outTension: 0.95 * extraTension * base:outTension;
}
...
@dictionary {
    center {
        nailtoblt: S"master#blackwide glyph#dvA penstroke#bow point:i(0) center":on;       
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtoblt: S"master#blackwide glyph#dvOcandra penstroke#bow point:i(0) center":on;       
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtoblt: S"master#blackwide glyph#dvO penstroke#bow point:i(0) center":on;       
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
