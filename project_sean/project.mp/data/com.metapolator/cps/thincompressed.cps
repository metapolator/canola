...
@dictionary {
    center {
        nailtotrb: S"master#thincompressed glyph#C penstroke#bow point:i(0) right":on;
...
@dictionary {
    center {
        nailtotrb: S"master#thincompressed glyph#E penstroke#armt point:i(1) center":on;
        nailtobrt: S"master#thincompressed glyph#E penstroke#armb point:i(1) center":on;
        nailtocrt: S"master#thincompressed glyph#E penstroke#armc point:i(1) center":on;
        nailtocrb: S"master#thincompressed glyph#E penstroke#armc point:i(1) center":on;
...
@dictionary {
    center {
        nailtotrb: S"master#thincompressed glyph#F penstroke#armt point:i(1) center":on;
        nailtocrt: S"master#thincompressed glyph#F penstroke#armc point:i(1) center":on;
        nailtocrb: S"master#thincompressed glyph#F penstroke#armc point:i(1) center":on;        
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtotrb: S"master#thincompressed glyph#G penstroke#bow point:i(0) right":on;
        nailtobow: S"master#thincompressed glyph#G penstroke#bow point:i(4) right":on;
        nailtobary: S"master#thincompressed glyph#G penstroke#bar point:i(0) right":on:y;
        nailtobarx: S"master#thincompressed glyph#G penstroke#stem point:i(0) center":on:x;
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtobrt: S"master#thincompressed glyph#L penstroke#arm point:i(1) center":on;   
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtoblt: S"master#thincompressed glyph#S penstroke#bow point:i(0) right":on;   
        nailtotrb: S"master#thincompressed glyph#S penstroke#bow point:i(6) left":on;   
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtoblt: S"master#thincompressed glyph#dollar penstroke#bow point:i(0) right":on;   
        nailtotrb: S"master#thincompressed glyph#dollar penstroke#bow point:i(6) left":on;   
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtotrb: S"master#thincompressed glyph#T penstroke#arm point:i(1) center":on;
        nailtotlb: S"master#thincompressed glyph#T penstroke#arm point:i(0) center":on;
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtobrt: S"master#thincompressed glyph#Z penstroke#stem point:i(-1) center":on;
        nailtotlb: S"master#thincompressed glyph#Z penstroke#stem point:i(0) center":on;
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    left {
        A: pointBefore:on:y;
        B: pointAfter:on:x;
        C: S"master#thincompressed glyph#Z penstroke#stem point:i(1) right":on:y;
        D: pointBefore:on:x;
    }
    right {
        A: pointAfter:on:y;
        B: pointBefore:on:x;
        C: S"master#thincompressed glyph#Z penstroke#stem point:i(-1) left":on:y;
        D: pointAfter:on:x;
    }
...
@dictionary {
    center {
        nailtotlb: S"master#thincompressed glyph#a penstroke#bow point:i(3) right":on;
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtotrb: S"master#thincompressed glyph#f penstroke#bow point:i(3) left":on;
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtotrb: S"master#thincompressed glyph#r penstroke#bow point:i(1) center":on;
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtoblt: S"master#thincompressed glyph#uni0904 penstroke#bow point:i(0) right":on;   
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtoblt: S"master#thincompressed glyph#aadeva penstroke#bow point:i(0) right":on;   
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtoblt: S"master#thincompressed glyph#adeva penstroke#bow point:i(0) right":on;   
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtoblt: S"master#thincompressed glyph#dvA penstroke#bow point:i(0) center":on;       
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtoblt: S"master#thincompressed glyph#dvOcandra penstroke#bow point:i(0) center":on;       
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
...
@dictionary {
    center {
        nailtoblt: S"master#thincompressed glyph#dvO penstroke#bow point:i(0) center":on;       
        serifx: pointBefore:on:x;
        serify: pointBefore:on:y;
    }
}
